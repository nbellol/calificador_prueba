...
# Generation Time: 2019-08-02 20:06:19 +0000
# ************************************************************
...
VALUES
	...
	(2,'pbkdf2_sha256$150000$AE396SOsvIzL$1JQqRCJuZwABquuXlw8LiWIHvUJnFDDJpqk3l59/H0U=','2019-08-02 19:31:27.950539',1,'mario','','','',1,1,'2019-08-02 19:31:09.188931');
...
VALUES
	...
	(58,'EE','Se recibió el envío 2',0,'2019-07-17 16:04:09.605517',9,'/envios/primerprob2/'),
	(59,'ER','Se revisó el intento #2 del problema \'Primer problema\'',0,'2019-07-17 16:04:09.609804',9,'/envios/primerprob2/'),
	(60,'EE','Se recibió el envío 2',0,'2019-08-02 16:25:36.124892',9,'/envios/primerprob2/'),
	(61,'ER','Se revisó el intento #2 del problema \'Primer problema\'',0,'2019-08-02 16:25:36.130133',9,'/envios/primerprob2/');
...
CREATE TABLE `dashboard_resultadoprueba` (
  ...
  `numero` int(11) NOT NULL,
  `mensaje` longtext COLLATE latin1_spanish_ci,
  PRIMARY KEY (`id`),
...
VALUES
	(1,'wey','Weymar Contreras','avatars/wey.png','ES','2019-06-28 17:34:47.081968','pbkdf2_sha256$150000$Weymar Contreras$lbAGs7tw8380m4P+hVTouDldJt9aa1/R5JwMd5sR+XY=',3,26),
	(2,'autor','Autor Problemas','avatars/autor.png','PR','2019-06-07 16:33:39.587000','autor',0,0),
	(8,'prof1','Francis Goldman','avatars/prof1.png','PR','2019-08-02 19:48:28.949811','pbkdf2_sha256$150000$Francis Goldman$sVC+f9Bw+aUKF4oS5vPkrEAN2PYGekcjGN+OQ1CUhKM=',0,0),
	(9,'est1','Juan Segundo','avatars/est1.png','ES','2019-06-28 17:34:26.653889','pbkdf2_sha256$150000$Juan Segundo$F57bVcPsK5YAi1Ey//aqplQk7K8+bmfcaArJxwfYyak=',0,0),
...
VALUES
	...
	('9uewx92d4k2q25bhsypb4y9wibose696','','2019-08-16 19:48:28.978369'),
